...
let images1 =[document.getElementById('a1'), document.getElementById('a3'), document.getElementById('c2')];
let images2 =[document.getElementById('a2'), document.getElementById('c1'), document.getElementById('c3')];
